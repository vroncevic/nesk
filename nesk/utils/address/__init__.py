...
"""
    ...
    #Usage
        ...
        IP Address is a logical address of the computer and is used to
        uniquely locate computer connected via a network.
    ...
    #Mapping
        IPv4 uses ARP (Address Resolution Protocol), map to MAC address.
        IPv6 uses NDP (Neighbour Discovery Protocol), map to MAC address.
    ...
    #Dual Stack
        IPv4 and IPv6 cannot communicate with other but can exist together on
        the same network.
"""
