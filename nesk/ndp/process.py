...
"""
 ...
 Info
     ...
     Created API for getting MAC address by using NDP.
"""
...
class Process:
    """
        ...
        It defines:
            ...
            :attributes:
                | NDP_CLI - ndp command line interface.
                | __l3 - IP address object-instance container.
                | __l2 - MAC address object-instance container.
            :methods:
                | get_mac - getting MAC address for IP address by NDP.
    """
    ...
    def get_mac(self, ip_address) -> str:
        """
            Getting MAC address for IP address by NDP.
